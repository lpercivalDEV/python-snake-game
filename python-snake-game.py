#Testing new code resource:
#this code works!  --> break it down 
...
# num_nums = [sh/2, sw/2]
# w.addch(num_nums[0], num_nums[1], curses.ACS_PI)
#
# #snake directions
...
#             num_nums = newfood if newfood not in snake else None
#         w.addch(num_nums[0],num_nums[1],curses.ACS_PI)
#     else:
#         tail = snake.pop()
